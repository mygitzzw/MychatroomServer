...
class ServerProcess extends Thread {
	public static Socket socket = null;// 定义客户端套接字

	public BufferedReader in;// 定义输入流
	public static PrintWriter out;// 定义输出流

	public static Vector onlineUser = new Vector(10, 5);
	public static Vector socketUser = new Vector(10, 5);

	public String strReceive, strKey;
	public StringTokenizer st;

	public final String USERLIST_FILE = "F:\\Android\\Work\\user.txt"; // 设定存放用户信息的文件
	public static ServerBuildFrame sFrame = null;


	//
	public ServerProcess(Socket client, ServerBuildFrame frame) throws IOException {
		socket = client;
		sFrame = frame;
	...
	// 在线用户列表
	public static void freshClientsOnline() throws IOException {
